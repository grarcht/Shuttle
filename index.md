...
graph TD
    A["Your Application"]
    A --> B["framework / core"]
    A --> C["framework-addons-<br/>navigation-component<br/>"]
    A --> D["your custom<br/>integration<br/>"]
    B --> E["framework-integrations-persistence<br/>/ abstraction layer<br/>"]
    E --> F["framework-integrations-extensions-room<br/>/ default implementation<br/>"]
```
