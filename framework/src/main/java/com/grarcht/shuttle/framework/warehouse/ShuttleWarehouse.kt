...
interface ShuttleWarehouse {
     ...
     */
    suspend fun <D : ShuttleCargoData> pickup(cargoId: String): Channel<ShuttlePickupCargoResult>
     ...
     */
    suspend fun <D : ShuttleCargoData> store(cargoId: String, data: D?): Channel<ShuttleStoreCargoResult>
