...
class ShuttleWarehouseTests {
    ...
    @Test
    fun verifyRemovingCargoByIdSucceedsWithAValidId() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
    ...
    @Test
    fun verifyRemovingCargoByIdFailsWithAnInvalidId() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
    ...
    @Test
    fun verifyRemovingCargoByIdFailsWhenFileCannotBeDeleted() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
    ...
    @Test
    fun verifyRemovingCargoByIdFailsWhenDAORemovalFails() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
    ...
    @Test
    fun verifyRemovingAllCargoSucceedsWhenDAORemovalSucceeds() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
    ...
    @Test
    fun verifyRemovingAllCargoFailsWhenGatewayRemovalFailsToRemoveIt() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
    ...
    @Test
    fun verifyRemovingAllCargoFailsWhenTheDirectoryDoesNotExist() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
    ...
    @Test
    fun verifyRemovingAllCargoFailsWhenDAOFailsToRemoveIt() {
        val dao = mock(ShuttleDataAccessObject::class.java)
        val dataModelFactory = mock(ShuttleDataModelFactory::class.java)
        val fileSystemGateway = mock(ShuttleFileSystemGateway::class.java)
        val warehouse: ShuttleWarehouse = ShuttleRepository(dao, dataModelFactory, CARGO_FILE_PATH, fileSystemGateway)
