...
class MockBundleFactory : BundleFactory {
    ...
    fun create(map: MutableMap<String?, Any?> = mutableMapOf()): Bundle {
        ...
        Mockito.doAnswer { invocation ->
            map.containsKey(invocation.arguments[0])
        }.`when`(bundle).containsKey(ArgumentMatchers.anyString())
        Mockito.doAnswer { invocation ->
        ...
        Mockito.doAnswer { MockBundleFactory::class.java.simpleName + "{map=" + map.toString() + "}" }.`when`(
            bundle
        ).toString()
        ...
        Mockito.`when`(
            bundle.getBoolean(ArgumentMatchers.anyString(), ArgumentMatchers.anyBoolean())
        ...
        Mockito.`when`(
            bundle.getByte(ArgumentMatchers.anyString(), ArgumentMatchers.anyByte())
        ).thenAnswer(getOrDefault)
        ...
        Mockito.`when`(
            bundle.getChar(ArgumentMatchers.anyString(), ArgumentMatchers.anyChar())
        ).thenAnswer(getOrDefault)
        ...
        Mockito.`when`(
            bundle.getShort(ArgumentMatchers.anyString(), ArgumentMatchers.anyShort())
        ).thenAnswer(getOrDefault)
        ...
        Mockito.`when`(
            bundle.getLong(ArgumentMatchers.anyString(), ArgumentMatchers.anyLong())
        ).thenAnswer(getOrDefault)
        ...
        Mockito.`when`(
            bundle.getFloat(ArgumentMatchers.anyString(), ArgumentMatchers.anyFloat())
        ).thenAnswer(getOrDefault)
        ...
        Mockito.`when`(
            bundle.getDouble(ArgumentMatchers.anyString(), ArgumentMatchers.anyDouble())
        ).thenAnswer(getOrDefault)
        ...
        Mockito.`when`(
            bundle.getString(ArgumentMatchers.anyString(), ArgumentMatchers.anyString())
        ).thenAnswer(getOrDefault)
        ...
        Mockito.`when`(bundle.getParcelableArrayList<Parcelable>(ArgumentMatchers.anyString(), anyArg())).thenAnswer(get)
        ...
        Mockito.`when`(bundle.getSparseParcelableArray<Parcelable>(ArgumentMatchers.anyString(), anyArg())).thenAnswer(get)
