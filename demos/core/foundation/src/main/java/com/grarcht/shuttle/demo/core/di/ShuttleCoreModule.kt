 ...
 *
 * [ShuttleRoomDbConfig] is provided by :demos-core-di for standard apps. Apps that need
 * non-default Room options (e.g. multi-process) supply their own binding instead.
 */
