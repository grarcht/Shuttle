...
val archivesName = "framework-annotations-compiler-plugin"
...
publishing {
    publications {
        create<MavenPublication>("distribution") {
            ...
            pom {
                name.set("Shuttle Annotations Compiler Plugin")
                description.set("Kotlin compiler plugin for the Shuttle framework.")
