...
val archivesName = "framework-annotations-processor"
...
publishing {
    publications {
        create<MavenPublication>("distribution") {
            ...
            pom {
                name.set("Shuttle Annotations Processor")
                description.set("KSP annotation processor for the Shuttle framework.")
